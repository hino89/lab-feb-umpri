            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm text-right flex justify-end gap-3">
                        <a href="{{ route('admin.laboratories.edit', $lab->id) }}" class="text-blue-600 hover:text-blue-900 font-medium flex items-center gap-1">
                        ...
                        <form action="{{ route('admin.laboratories.destroy', $lab->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus laboratorium ini?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="text-red-600 hover:text-red-900 font-medium flex items-center gap-1">
